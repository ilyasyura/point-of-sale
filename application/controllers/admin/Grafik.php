...
class Grafik extends CI_Controller{
	...
	function graf_penjualan_pertanggal(){
      ...
      //   $tahun = $this->input->post('thn');
		...
		$x['report']=$this->m_grafik->graf_penjualan_pertanggal($tanggal_awal,$tanggal_akhir);
		$x['tgl']='';
		$this->load->view('admin/grafik/v_graf_penjualan_pertanggal',$x);
	}
