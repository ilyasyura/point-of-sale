...
<body>
        ...
        <div class="row">
           ...
           <!--  <form action="<?php echo base_url().'admin/penjualan/simpan_penjualan'?>" method="post"> -->
            <table style="margin-left: 800px">
             ...
             <a class="btn btn-xs btn-warning" href="#modalBayar" data-toggle="modal" title="Bayar" style="margin-left: 1010px"><span class="fa fa-money"></span> Bayar</a>
            <hr/>
        </div>
        <!-- /.row -->
        <!-- ============ MODAL ADD =============== -->
 ...
 <div id="modalBayar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="modal-content">
                    <div class="modal-header">
         <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/penjualan/simpan_penjualan'?>">
         <tr>
            <tr>
