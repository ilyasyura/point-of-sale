            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        ...
                        $barang_distributor=$a['barang_distributor'];
                        $barang_tgl_last_update=$a['barang_tgl_last_update'];
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo $barang_distributor;?></td>
                         <td style="text-align:center;"><?php echo $barang_tgl_last_update;?></td>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a class="btn btn-xs btn-primary" href="#modalEditStok<?php echo $id?>" data-toggle="modal" title="Edit Stok"><span class="fa fa-edit"></span>Stok</a>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/tambah_barang'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="harpok" class="harpok form-control" type="text" placeholder="Harga Beli" style="width:335px;">
                        </div>
                    </div>
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            <!-- <label class="control-label col-xs-3" >Stok</label> -->
                            <div class="col-xs-9">
                                <input name="stok" class="form-control" type="hidden" value="<?php echo $stok;?>" placeholder="Stok..." style="width:335px;" required>
                            </div>
                        </div>
...
<!-- ============ MODAL STOK =============== -->
  ...
  <?php
                    foreach ($data->result_array() as $a) {
                        ...
                        $harjul=$a['barang_harjul'];
                        $barang_distributor=$a['barang_distributor'];
                        $barang_masuk=$a['barang_masuk'];
                        $stok=$a['barang_stok'];
                        $kat_id=$a['barang_kategori_id'];
                        $kat_nama=$a['kategori_nama'];
                    ?>
                <div id="modalEditStok<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_stok'?>">
                        <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Nama Barang</label>
                            <div class="col-xs-9">
                                <input name="nabar" class="form-control" type="text" value="<?php echo $nm;?>" placeholder="Nama Barang..." style="width:335px;" readonly>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="barang_distributor" class="form-control" type="text" placeholder="Nama Supplier" style="width:335px;" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Barang Masuk</label>
                        <div class="col-xs-9">
                            <input name="barang_masuk" class="form-control" type="number" placeholder="Jumlah Barang Masuk" style="width:335px;" required>
                        </div>
                    </div> 
                </div>
                                ...
                                <input name="kategori" class="form-control" type="hidden" value="<?php echo $id_kat;?>" placeholder="Nama Barang..." style="width:335px;" required>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Satuan</label>
                            <div class="col-xs-9">
                                <input name="satuan" class="form-control" type="text" value="<?php echo $satuan;?>" placeholder="Nama Barang..." style="width:335px;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga Beli</label>
                            <div class="col-xs-9">
                                <input name="harpok" class="harpok form-control" type="text" value="<?php echo $harpok;?>" placeholder="Harga Pokok..." style="width:335px;" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Harga Jual</label>
                            <div class="col-xs-9">
                                <input name="harjul" class="harjul form-control" type="text" value="<?php echo $harjul;?>" placeholder="Harga Jual..." style="width:335px;" readonly>
                            </div>
                        </div>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2020';?></p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
