...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>REKAP PENJUALAN PERTANGGAL</h4></center><br/></td>
</tr>
...
?>
    <tr>
        <td colspan="6" style="text-align:center;"><b>Total</b></td>
         <td style="text-align:center;"><b><?php echo 'Rp' .number_format($b['total_jual']);?></b></td>
        <td style="text-align:center;"><b><?php echo number_format($b['total_jumlah']);?></b></td>
        <td style="text-align:center;"><b><?php echo 'Rp '.number_format($b['total_diskon']);?></b></td>
