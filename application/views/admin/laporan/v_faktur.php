...
<table border="0" align="center" style="width:700px;border:none;">
        ...
        <tr>
        <th style="text-align:left;">Nama Kasir : <?php echo $this->session->userdata('nama');?></th>
...
<table border="0" align="center" style="width:700px;border:none;">
        ...
        <tr>
            ...
            <th style="text-align:left;">: <?php date_default_timezone_set("Asia/Jakarta"); echo date("d-m-Y H:i:s"); ?></th>
