    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Grafik Penjualan PerTanggal</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_jual_pertanggal" data-toggle="modal"><span class="fa fa-eye"></span> Lihat</a>
                        </td>
                    </tr>
        ...
        <!-- ============ MODAL ADD =============== -->
          <div class="modal fade" id="lap_jual_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/grafik/graf_penjualan_pertanggal'?>" target="_blank">
