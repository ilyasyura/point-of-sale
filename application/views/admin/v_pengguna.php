                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                           ...
                           <?php elseif ($a['user_status'] == "0") : ?>
                             <a class="btn btn-xs btn-danger disabled" href="#modalHapusPelanggan<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-close disabled"></span> Nonaktifkan</a>
                             <?php endif; ?>
                             <?php if ($a['user_status'] == "1") : ?>
                           <a class="btn btn-xs btn-success disabled" href="#modalAktifkan<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-true"></span> Aktifkan</a>
                            <?php elseif ($a['user_status'] == "0") : ?>
                                <a class="btn btn-xs btn-success" href="#modalAktifkan<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-true"></span> Aktifkan</a>
                            <?php endif; ?>
                              <a class="btn btn-xs btn-danger" href="#modalHapusPengguna<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Hapus</a>    
                        </td>
        ...
        <hr>
         <?php
                    foreach ($data->result_array() as $a) {
                        ...
                        $status=$a['user_status'];
                    ?>
                <div id="modalHapusPengguna<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
