...
function graf_penjualan_pertanggal($tanggal_awal,$tanggal_akhir){
     $query=$this->db->query("SELECT DATE_FORMAT(jual_tanggal,'%d' '%M') AS tanggal,SUM(jual_total) total FROM tbl_jual WHERE jual_tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'GROUP BY DAY(jual_tanggal)");
